...
/*  ['react', 'react/addons'].forEach(function (pkg) { //original by JWatson*/
  ['react', 'react-dom', 'react-router'].forEach(function (pkg) { //confirmed works with nuka-carousel
  // ['react'].forEach(function (pkg) {//dunno where i got this! LOL
		app.exclude(pkg);
		react.require(pkg);
	});
